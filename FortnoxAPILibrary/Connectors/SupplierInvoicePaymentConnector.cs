...
{
    /// <remarks/>
    public class SupplierInvoicePaymentConnector : EntityConnector<SupplierInvoicePayment, EntityCollection<SupplierInvoicePaymentSubset>>, ISupplierInvoicePaymentConnector
	{
