...
{
    public interface IOrderConnector : IFinancialYearBasedEntityConnector<Order, Orders, Sort.By.Order>
    {
        /// <summary>
    ...
    /// <remarks/>
	public class OrderConnector : FinancialYearBasedEntityConnector<Order, Orders, Sort.By.Order>, IOrderConnector
    {
		/// <summary>
		/// Use with Find() to limit the search result
		/// </summary>
