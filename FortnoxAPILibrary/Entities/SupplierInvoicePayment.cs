...
namespace FortnoxAPILibrary
{
	...
	public partial class SupplierInvoicePayment
	{
		...
		private string invoiceSupplierNameField;

		private string invoiceSupplierNumberField;
		...
		private List<SupplierInvoiceWriteOff> writeOffsField;
		...
		/// <summary>This field is Read-Only in Fortnox</summary>
		[System.ComponentModel.ReadOnly(true)]
		public string InvoiceSupplierName
		{
			get
			{
				return this.invoiceSupplierNameField;
			}
			set
			{
				this.invoiceSupplierNameField = value;
			}
		}
		...
		public string InvoiceSupplierNumber
		{
			get
			{
				return this.invoiceSupplierNumberField;
			}
			set
			{
				this.invoiceSupplierNumberField = value;
			}
		}
		...
		public List<SupplierInvoiceWriteOff> WriteOffs
		{
			get
			{
