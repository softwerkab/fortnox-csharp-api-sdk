...
namespace FortnoxAPILibrary
{
	...
	public partial class PriceLists
	{
		...
		private List<PriceListSubset> priceListSubsetField;
		...
		public List<PriceListSubset> PriceListSubset
		{
			get
			{
				return this.priceListSubsetField;
			}
			set
			{
				this.priceListSubsetField = value;
			}
		}
